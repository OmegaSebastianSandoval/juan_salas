        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="preguntas_pregunta" value="<?php echo $this->getObjectVariable($this->filters, 'preguntas_pregunta') ?>"></input>
		            </label>
		        </div>
				<div class="col-2">
		            <label>Estado</label>
		            ...
		            <input type="text" class="form-control" name="preguntas_estado" value="<?php echo $this->getObjectVariable($this->filters, 'preguntas_estado') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Fecha</label>
		            ...
		            <input type="text" class="form-control" name="preguntas_fecha" value="<?php echo $this->getObjectVariable($this->filters, 'preguntas_fecha') ?>"></input>
		            </label>
		        </div>
                <div class="col-2">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->preguntas_id; ?>
                <?php 
                    if($content->preguntas_estado == 1) {
                        $estado = "Activo";
                    } else {
                        $estado = "Inactivo";
                    }
                ?>
					<tr>
						<td><?=$content->preguntas_pregunta;?></td>
						<td><?=$estado;?></td>
						<td><?=$content->preguntas_fecha;?></td>
						<td class="text-right">
							<div>
