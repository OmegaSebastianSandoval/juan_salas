	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="ciudad">
	                        ...
	                        <?php foreach ($this->list_ciudad as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'ciudad') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="sector">
	                        ...
	                        <?php foreach ($this->list_sector as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'sector') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="localidad">
	                        ...
	                        <?php foreach ($this->list_localidad as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'localidad') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
			...
			<tbody>
				...
				<?php $id =  $content->id; ?>
					<tr>
						...
						<td class="text-right">
							<div>
								<a class="btn btn-verde btn-sm" href="/administracion/fotos/?inmueble=<?= $id ?>"  data-bs-toggle="tooltip" data-placement="top" title="Agregar Imagenes"><i class="fas fa-images"></i></a>
