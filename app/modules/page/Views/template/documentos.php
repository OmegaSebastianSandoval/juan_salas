<div class="docs-container docs-container-<?php echo $contenedor->contenido_id; ?> <?php echo $contenedor->contenido_columna; ?> py-4 <?php if ($contenedor->contenido_caja == 1) {
